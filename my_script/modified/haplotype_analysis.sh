...
do
  ...
  mkdir modifiedpvalue_${phenotype}
  cd modifiedpvalue_${phenotype}
...
#      python /home/riceUsers/lhr/soybean/src/my_script/python_script/old/haplotype_to_phenotype.py /home/riceUsers/lhr/soybean/temp_file/single/${gene}_haplotype.txt /home/riceUsers/lhr/soybean/genomefile/${phenotype}.txt ${year} ${gene} ${phenotype}
      # 检验数据正态分布（kstest，p>0.05）、方差齐性（levene,p>0.01）最后做方差分析(anova_lm，p<0.01)，多重比较（pairwise_tukeyhsd,p<0.05）
      python /home/riceUsers/lhr/soybean/src/my_script/modified/anova.py /home/riceUsers/lhr/soybean/output/${phenotype}_old_no_normaltest/${year}/${gene}_${phenotype}_${year}_hap2phe.csv 0.05 /home/riceUsers/lhr/soybean/output/modifiedpvalue_${phenotype}/${year}/normality_result_${gene}_${year}_${phenotype}.txt /home/riceUsers/lhr/soybean/output/modifiedpvalue_${phenotype}/${year}/variance_homogeneity_result_${gene}_${year}_${phenotype}.txt /home/riceUsers/lhr/soybean/output/modifiedpvalue_${phenotype}/${year}/filter_result_${gene}_${year}_${phenotype}.txt /home/riceUsers/lhr/soybean/output/modifiedpvalue_${phenotype}/${year}/anova_result_${gene}_${year}_${phenotype}.txt /home/riceUsers/lhr/soybean/output/modifiedpvalue_${phenotype}/${year}/multiple_comparison_result_${gene}_${year}_${phenotype}.csv
    done
    cd ..
  done
  cd ..
