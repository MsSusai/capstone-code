...
#do
  ...
  do
    ...
    anovapath_2016=/home/riceUsers/lhr/soybean/final_results/haplotype/${phenotype}/2016yzBL/anova_result_${gene}_2016yzBL_${phenotype}.txt
    ...
    python /home/riceUsers/lhr/soybean/src/my_script/python_script/anova_data.py ${anovapath_2016} ${gene} ${phenotype} /home/riceUsers/lhr/soybean/final_results/output/anova_data_${phenotype}.csv
  done
#done